...
public class GameResult {
    ...
    private Queue<Card> deckOfCard;
    private Stack<Card> pileOfCard;

    public GameResult(int qOfSteps, Queue<Card> deckOfCards, Stack<Card> pileOfCards) {
    ...
    public static GameResult solve(Card[] cardArray) throws Exception {
        Queue<Card> DeckOfCards = new LinkedList<>();
        Stack<Card> PileOfCards = new Stack<>();
        ...
        qOfSteps -= counter;
        GameResult gameResult = new GameResult(qOfSteps, DeckOfCards, PileOfCards);
        return gameResult;
    }
